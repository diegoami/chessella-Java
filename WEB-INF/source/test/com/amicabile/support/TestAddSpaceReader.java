...
public class TestAddSpaceReader extends TestCase {
   ...
   public static void main(String[] args) {
      TestRunner.run(TestAddSpaceReader.class);
   }
   ...
   public void testAddSpaceReader() throws Exception {
      ...
      AddSpaceReader addSpaceReader = new AddSpaceReader(fileReader);
      BufferedReader bufReader = new BufferedReader(addSpaceReader);
      String buf = null;
